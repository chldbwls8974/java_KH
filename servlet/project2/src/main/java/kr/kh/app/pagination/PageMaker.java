...
public class PageMaker {
	...
	private int displayPageNum; // 보ㅕㅇ주는 페이지 최대 개수 
	private Criteria cri; // 현재 페이지 정보
	private int totalCount; // 게시글 전체 수 >> endPage 계산을 위해 필요
	
	// 페이지네이션 정보를 계산하는 메서드
	public void calculate() {
		// 주어지는 정보 : 현재 페이지 정보, 전체 게시글, 한 페이지네이션에서 보여주는 페이지 최대 개수
		// 예시 : 현재 페이지가 1페이지이고, 한 페이지에 게시글이 5개 , 전체 게시글은 15개, 
		...
		// 첫 페이지 네이션 이면 시작 페이지가 1이면 이전 ㅍ버튼 비활성화
		prev = startPage == 1? false : true;
		
		// 마지막 페이지네이션이면 : lastEnd와 end가 같으면 다음 버튼 활성화
