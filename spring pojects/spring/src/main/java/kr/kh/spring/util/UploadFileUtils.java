...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalFileName, byte[] fileData) throws IOException {
		...
		UUID uuid = UUID.randomUUID(); // 8-4-4-4-12_파일명
	...
	/***
	 * uploadPath에 기준날짜에 맞는 년/ 월/일 폴더가 없으면 생성하고, 폴더의 경로를 반환하는 메서드
	 * @param uploadPath 년월일 폴더를 만들 부모 폴더
	 * @return 기준날짜에 년월일 폴더 경로
	 */
